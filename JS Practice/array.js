 ...
 * 
 * Index - each time in an array is stored
...
//unshift() --- add an item from the front of array
fruits.unshift('corn');
console.log(`Using the unshift(): ${fruits}`);

//splice() --- remove the first element of an array
fruits.splice(2,1,'watermelon');
console.log(`Using the splice(2,1,...): ${fruits}`);
...
colours.splice(1, 0, "purple");
console.log(colours);

//slice(<target index>, <remove item>, <insert item>)

//slice()
// new array containing elements from index[1] (inclusive) to index[2](exclusive)
let slicedFruits =fruits.slice(1,3);

//slice(<starting index -- index of the first item to include(inclusive), <ending index -- index of ite after the last item to include(exclusive)> )
console.log("Old array", fruits);
console.log("Sliced array", slicedFruits);

//lenght --- used to get the size of array
let numberOfFruits = fruits.length;
console.log(`Fruits array length: ${numberOfFruits}`);
console.log(`slicedFruits array length: ${slicedFruits.length}`);

//indexOf -- used to find and return of an item in the array
...
fruits.forEach(function(fruit) {
    console.log(`forEach loops: ${fruit}`);
})